# Generated by Django 4.2.15 on 2025-01-06 13:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('STD', 'Standard'), ('DLX', 'Deluxe'), ('SUI', 'Suite')], max_length=3)),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('available', models.BooleanField(default=True)),
                ('max_occupancy', models.IntegerField(default=2)),
                ('size', models.IntegerField(default=0, help_text='Size in square feet')),
            ],
        ),
        migrations.CreateModel(
            name='RoomImage',
